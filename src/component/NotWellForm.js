...
class NotWellForm extends React.Component {
  constructor(props) {
    super(props);
      this.state = {
        topics: [],
    ...
    render() {    
      ReactDOM.render(<DisplayList state={this.state} /> , document.getElementById("notWellTemplate"));
      return (
        <div class="row">
           <div class="col-sm-4">
              ...
              <h4>Topic</h4>
                ...
                {this.state.subtopic.map((subtopic, idx) => (
                  <div className="">
                    ...
                    />
                    <button type="button" className="btn btn-primary"  onClick={this.handleRemoveSubtopic(idx)}><span class="glyphicon glyphicon-remove"></span></button>
                  </div>
                ))}
